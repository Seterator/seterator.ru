        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VkProfile = table.Column<string>(nullable: true),
                    FbProfile = table.Column<string>(nullable: true),
                    InstProfile = table.Column<string>(nullable: true),
                    UserUrls = table.Column<string>(nullable: true),
                    PublicEmail = table.Column<string>(nullable: true),
                    PublicPhone = table.Column<string>(nullable: true),
